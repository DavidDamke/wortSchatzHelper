...
public class Settings {
    ...
    private void initSettings() {
     ...
     private void testTree() {
         ...
         folder1.add(new DefaultMutableTreeNode(new JCheckBox("Test2").getText()));
         folder1.add(new DefaultMutableTreeNode(new JCheckBox("Test3").getText()));
         ...
         tree.setTransferHandler(new ListTransferHandler(0,null));
    ...
    private JScrollPane createPriorityScrollPane(String title, DefaultListModel<String> model, int priority) {
        ...
        list.setTransferHandler(new ListTransferHandler(priority, model));
    ...
    private void submit(JTextField textField) {
        if (!textField.getText().isEmpty() && !hasWord(textField.getText())) {
            ...
            // checkBoxPanel.add(checkBox);
            //TODO: Hier muss es dann einem Ordner Hinzugefügt werden.

            //updateCheckBoxes();

            //TODO: Hier dann Speichern
    ...
    //TODO Methode ändern das Gescheckt wird of das Wort in dem Ordner Bereits vorkommt.
    ...
    private void selectWords(ArrayList<String> selectedWordList) {
        //TODO Hier ganze logik ändern. "Select" es nicht mehr direkt, da es Per Drag and Drop passiert. 
    ...
    //     //TODO: Möglicherweiße garnicht mehr nötig wenn ganze Ordner Per Drag und Drop verwendet werden können.
